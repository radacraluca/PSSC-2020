...
namespace Tema5Radac.Primitives.IO.Mocking
{
    ...
    public delegate TResult Effect2<TEnum, TIn1, TIn2, TResult>(TEnum defaultEffect, Func<TIn1, TIn2, TResult> func,TIn1 param1, TIn2 param2);

    public delegate TResult Effect3<TEnum, TIn1, TIn2, TIn3, TResult>(TEnum defaultEffect,Func<TIn1, TIn2, TIn3, TResult> func, TIn1 param1, TIn2 param2, TIn3 param3);

    public delegate TResult Effect4<TEnum, TIn1, TIn2, TIn3, TIn4, TResult>(TEnum defaultEffect,Func<TIn1, TIn2, TIn3, TIn4, TResult> func, TIn1 param1, TIn2 param2, TIn3 param3, TIn4 param4);

    public delegate TResult Effect<TEnum, TIn1, TIn2, TIn3, TIn4, TIn5, TResult>(TEnum defaultEffect, Func<TIn1, TIn2, TIn3, TIn4, TIn5, TResult> func, TIn1 param1, TIn2 param2, TIn3 param3,TIn4 param4, TIn5 param5);
